...
DEFAULT_CONFIG = {
    ...
    "algo": {
        ...
        "quality_required_level": "basic",
        "quality_use_manual_required_fields": "0",
        "quality_required_fields": "name,category_type,daily_change,turnover,lead_stock,volume",
